...
#define DOUBLE_FAN 900000         // время работы вентилятора
...
struct Status {
  bool status_vent;   //  статус вентиля 
  bool status_air_humidity; // статус влажности воздуха (40)
  bool status_dirt_humidity; // статус земли 
  bool status_heat; // статус тепла
  bool status_light;
  bool double_fan = true;  //
...
void timer() {
  ...
  if (TIME_SECONDS >= TIME_NIGHT)
  {
    TIME_SECONDS = 0;
    Status.double_fan = true;
  } 
  delay(1000);
}
